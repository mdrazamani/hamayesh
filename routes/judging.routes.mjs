...
import { createController } from "../app/controllers/article/judging/create.controller.mjs";
import { deleteController } from "../app/controllers/article/judging/delete.controller.mjs";
import { indexController } from "../app/controllers/article/judging/index.controller.mjs";
import { showController } from "../app/controllers/article/judging/show.controller.mjs";
import { updateController } from "../app/controllers/article/judging/update.controller.mjs";
import {
    judgingValidationSchema,
...
router.post(
    "/",
    authenticateJWT,
    dynamicValidate(judgingValidationSchema),
    createController
);
